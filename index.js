var subMenu =[
			{"name":"专辑","icon":"images/pic_00.png","x":0,"y":0,"w":1,"h":2,"focusImg":"images/focus-454x294.png","type":1,"focusDiv":"content_0_00","link":""},
			{"name":"专辑","icon":"images/pic_01.png","x":1,"y":0,"w":2,"h":1,"focusImg":"images/focus-220x294.png","type":2,"focusDiv":"content_0_01","link":""},
			{"name":"专辑","icon":"images/pic_02.png","x":3,"y":0,"w":1,"h":2,"focusImg":"images/focus-220x294.png","type":0,"focusDiv":"content_0_03","link":""},
			{"name":"专辑","icon":"images/pic_03.png","x":4,"y":0,"w":1,"h":2,"focusImg":"images/focus-220x294.png","type":0,"focusDiv":"content_0_04","link":""},
			{"name":"专辑","icon":"images/pic_04.png","x":1,"y":1,"w":1,"h":1,"focusImg":"images/focus-220x140.png","type":0,"focusDiv":"content_0_11","link":""},
			{"name":"专辑","icon":"images/pic_05.png","x":2,"y":1,"w":1,"h":1,"focusImg":"images/focus-220x140.png","type":0,"focusDiv":"content_0_12","link":""}
...
function grabEvent(_event){
	...
	switch(code){
		...
		case "KEY_NUMBER9": //
			...
			break;
		case "KEY_SELECT": //	
			window.location.href="healthRecords.html?userId=20160801";
			return 0;
			break;
		case "KEY_EXIT":
		case "KEY_BACK":
...
var subMenuObj = {
	...
	updateFocus:function(){
		...
		var top    = (item.y - 0) * this.hStep -86;
